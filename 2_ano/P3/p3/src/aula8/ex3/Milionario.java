 ...
 *
 */
public class Milionario extends JFrame {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 7953356386847914483L;
    ...
    public Milionario(String questionsFName) 
    throws IOException 
    {
        questions = new ListQuestions(questionsFName);
        quest = questions.getQuestion();
        this.setSize(600, 600);
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.setTitle("Quem quer ser milionario?");
    ...
    throws IOException 
    {
    	amount = new JLabel(String.valueOf(quest.getPrize()) + "€", SwingConstants.CENTER);
        ...
        call = new JButton("Telefone...");
        fifty = new JButton("50-50");
        JButton giveUp = new JButton("Desistir");
    ...
    private void call() 
    {
        ...
        textMessage += "\n" + getButtonText(arr[0]) + " or " +  getButtonText(arr[1]);
    ...
    private void nextQuestionOrWin() 
    throws IOException 
    {
