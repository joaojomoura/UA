...
void configUart(unsigned int baud, char parity, unsigned int stopbits)
{
    ...
    U2STAbits.URXEN = 1;    //receiver enabled
    U2STAbits.UTXEN = 1;    //transmitter enabled

    IPC8bits.U2IP = 2;      //priority 2
    IEC0bits.U2RXIE = 1;    //interrupts enabled
    IFS0bits.U2RXIF = 0;    //clear reception interrupts flag
