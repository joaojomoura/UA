...
public class Test {
	...
	public static void main(String[] args) {
		...
		lista.add(new Circulo(2)); lista.add(new Circulo(1, 1, 3));
		lista.add(new Quadrado(5)); lista.add(new Quadrado(2,3, 4));
		lista.add(new Rectangulo(3,2)); lista.add(new Rectangulo(3, 5, 3, 4));
		lista.add(new Rectangulo(5, 6, 1, 1));
