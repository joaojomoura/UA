...
public class Ordenar1 {
    public static void main(String[] args) throws IOException{
        ...
        //TESTAR tempos de ordenação para tamanh de 100, 1000 e 10000
        long t1;
        long t2,t3,t4;
        int[] teste;
        System.out.printf("%5s %12s %12s%n","Comp.","Select","Bubble");
        for (int size=100; size<20000; size=size*10) {
            teste = gerarArray(size);
            t1 = System.nanoTime();
            selectSort(teste);
            t2 = System.nanoTime();
            ...
            bubbleSort(teste);
            t4 = System.nanoTime();
            System.out.printf("%5d %12d %12d %4d%n",size,(t2-t1)/1000,(t4-t3)/1000, (t2-t1)/(t4-t3));
        }
    }
